...
(nby/with-feature
 ...
 (color-theme-tomorrow--with-colors
  ...
  (custom-set-faces
   ...
   `(powerline-clock-active ((t (:background ,selection :inherit mode-line))))
   `(powerline-flag-on
     ((t (:background ,green :foreground ,background :inherit mode-line))))
   `(powerline-active1 ((t (:background ,current-line :inherit mode-line))))
   `(powerline-active2 ((t (:background ,selection  :inherit mode-line)))))))
